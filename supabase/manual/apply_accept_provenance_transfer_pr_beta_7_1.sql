-- PR-BETA.7.1 (partial) — accept_provenance_transfer only
-- Live DB already has: provenance BI trigger, hard-fail sync, list_collector_owned_artwork_ids.
-- This patch replaces accept RPC to resolve seller from ledger (get_current_owner).

-- ---------------------------------------------------------------------------
-- 1) Replace accept_provenance_transfer
-- ---------------------------------------------------------------------------
