...
export const LANDING_NARRATIVE_CHECKPOINTS: NarrativeCheckpoint[] = [
  { id: "net-hero", color: "#7c3aed", label: "Platform" },
  { id: "net-pillars", color: "#2563eb", label: "Four pillars" },
  { id: "net-roles", color: "#9333ea", label: "Role value" },
  { id: "net-products", color: "#0ea5e9", label: "Surfaces" },
  { id: "net-cta", color: "#111827", label: "Begin" },
];
