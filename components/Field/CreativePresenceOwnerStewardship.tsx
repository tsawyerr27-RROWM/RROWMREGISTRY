...
export function CreativePresenceOwnerStewardship({ items }: Props) {
  ...
  return (
    <section className="mt-8 rounded-2xl border border-amber-200/70 bg-amber-50/50 px-5 py-5 md:px-6">
      <h2 className="font-serif text-lg font-normal text-amber-950">
        {t("field.creative.stewardship.heading")}
      </h2>
      <p className="mt-2 text-sm leading-relaxed text-amber-950/90">
        {t("field.creative.stewardship.lede")}
      </p>
      ...
      >
        {t("field.creative.stewardship.studioLink")}
      </Link>
    </section>
  );
}
