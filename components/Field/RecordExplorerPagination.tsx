...
export function RecordExplorerPagination({
  basePath,
  page,
  total,
  q,
  ...
  const start = total === 0 ? 0 : (page - 1) * FIELD_RECORD_EXPLORER_PAGE_SIZE + 1;
  const end = Math.min(page * FIELD_RECORD_EXPLORER_PAGE_SIZE, total);
